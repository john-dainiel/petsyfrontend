...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if(canvas) {
    ...
    async function preloadRunnerImages() {
      await Promise.all([
    ...
    function runnerGameLoop() {
      ...
      coins.forEach((c,i)=> {
        c.y+=4; ctx.drawImage(coinImg,c.x,c.y,c.width,c.height);
